...
writePort(hFPGA, "regIn.rx_src_sel", 0);        % 0 = AXI-stream data, 1 = ADC data
writePort(hFPGA, "regIn.capture_src_sel", 1);   % 0 = QPSK rx data, 1 = (AXI-stream data/ADC data)

writePort(hFPGA, "regIn.capture_start", 1);
writePort(hFPGA, "regIn.capture_length", 1024);
