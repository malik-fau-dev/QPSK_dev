...
#
# Script generated by Vivado on Tue Sep 16 11:59:18 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : usp_rfdc_0.sh
...
#
# Usage        : usp_rfdc_0.sh
#                usp_rfdc_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                usp_rfdc_0.sh [-reset_run]
#                usp_rfdc_0.sh [-reset_log]
#                usp_rfdc_0.sh [-help]
#
...
# script info
echo -e "usp_rfdc_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./usp_rfdc_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot usp_rfdc_0 xil_defaultlib.usp_rfdc_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim usp_rfdc_0 -key {Behavioral:sim_1:Functional:usp_rfdc_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_302b.protoinst" -protoinst "protoinst_files/bd_f07a.protoinst" -protoinst "protoinst_files/qpsk_for_htg.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb usp_rfdc_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./usp_rfdc_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: usp_rfdc_0.sh [-help]\n\
Usage: usp_rfdc_0.sh [-step]\n\
Usage: usp_rfdc_0.sh [-lib_map_path]\n\
Usage: usp_rfdc_0.sh [-reset_run]\n\
Usage: usp_rfdc_0.sh [-reset_log]\n\
Usage: usp_rfdc_0.sh [-keep_index]\n\
Usage: usp_rfdc_0.sh [-noclean_files]\n\n\
