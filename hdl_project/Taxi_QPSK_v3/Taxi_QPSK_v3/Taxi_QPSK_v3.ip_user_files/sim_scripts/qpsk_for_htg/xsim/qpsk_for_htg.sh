...
#
# Script generated by Vivado on Thu Sep 18 13:02:55 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : qpsk_for_htg.sh
...
#
# Usage        : qpsk_for_htg.sh
#                qpsk_for_htg.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                qpsk_for_htg.sh [-reset_run]
#                qpsk_for_htg.sh [-reset_log]
#                qpsk_for_htg.sh [-help]
#
...
# script info
echo -e "qpsk_for_htg.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./qpsk_for_htg.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconcat_v2_1_6 -L xlconstant_v1_1_9 -L gigantic_mux -L axi_protocol_converter_v2_1_33 -L axi_clock_converter_v2_1_32 -L blk_mem_gen_v8_4_9 -L axi_dwidth_converter_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot qpsk_for_htg xil_defaultlib.qpsk_for_htg xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim qpsk_for_htg -key {Behavioral:sim_1:Functional:qpsk_for_htg} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_302b.protoinst" -protoinst "protoinst_files/bd_f07a.protoinst" -protoinst "protoinst_files/qpsk_for_htg.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb qpsk_for_htg.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./qpsk_for_htg.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: qpsk_for_htg.sh [-help]\n\
Usage: qpsk_for_htg.sh [-step]\n\
Usage: qpsk_for_htg.sh [-lib_map_path]\n\
Usage: qpsk_for_htg.sh [-reset_run]\n\
Usage: qpsk_for_htg.sh [-reset_log]\n\
Usage: qpsk_for_htg.sh [-keep_index]\n\
Usage: qpsk_for_htg.sh [-noclean_files]\n\n\
