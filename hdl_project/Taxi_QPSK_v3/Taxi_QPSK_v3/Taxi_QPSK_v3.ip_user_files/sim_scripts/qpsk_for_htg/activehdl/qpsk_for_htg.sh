...
#                script (type 'qpsk_for_htg.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Taxi/temp_back_of_v3/Taxi_QPSK_v3/Taxi_QPSK_v3/Taxi_QPSK_v3.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
