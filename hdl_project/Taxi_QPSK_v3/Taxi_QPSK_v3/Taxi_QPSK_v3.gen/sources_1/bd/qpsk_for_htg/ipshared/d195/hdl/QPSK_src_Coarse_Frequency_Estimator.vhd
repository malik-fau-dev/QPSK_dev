-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Coarse_Frequency_Estimator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Coarse_Frequency_Estimator
...
ENTITY QPSK_src_Coarse_Frequency_Estimator IS
...
END QPSK_src_Coarse_Frequency_Estimator;


ARCHITECTURE rtl OF QPSK_src_Coarse_Frequency_Estimator IS

  -- Component Declarations
  COMPONENT QPSK_src_Integrator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  COMPONENT QPSK_src_Extract_Frequency
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          datain_re                       :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En24
  ...
  FOR ALL : QPSK_src_Integrator
    USE ENTITY work.QPSK_src_Integrator(rtl);

  FOR ALL : QPSK_src_Extract_Frequency
    USE ENTITY work.QPSK_src_Extract_Frequency(rtl);
  ...
  SIGNAL Delay_out1_re                    : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Delay_out1_im                    : signed(15 DOWNTO 0);  -- sfix16_En12
  ...
  SIGNAL Integrator_IntegOut_re           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Integrator_IntegOut_im           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Integrator_IntegValid            : std_logic;
  SIGNAL Integrator_IntegOut_re_signed    : signed(31 DOWNTO 0);  -- sfix32_En24
  SIGNAL Integrator_IntegOut_im_signed    : signed(31 DOWNTO 0);  -- sfix32_En24
  ...
  SIGNAL Extract_Frequency_normFreqOut    : std_logic_vector(34 DOWNTO 0);  -- ufix35

BEGIN
  u_Integrator : QPSK_src_Integrator
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Extract_Frequency : QPSK_src_Extract_Frequency
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        Delay12_out1_re <= Delay_out1_re;
        Delay12_out1_im <= Delay_out1_im;
      END IF;
    END IF;
  ...
  Integrator_IntegOut_re_signed <= signed(Integrator_IntegOut_re);

  Integrator_IntegOut_im_signed <= signed(Integrator_IntegOut_im);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        Delay10_out1_re <= Integrator_IntegOut_re_signed;
        Delay10_out1_im <= Integrator_IntegOut_im_signed;
      END IF;
    END IF;
  ...
  normFreqEst <= Extract_Frequency_normFreqOut;
