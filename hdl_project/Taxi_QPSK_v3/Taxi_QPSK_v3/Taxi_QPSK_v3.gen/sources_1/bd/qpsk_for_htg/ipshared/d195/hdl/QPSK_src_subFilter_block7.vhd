-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_subFilter_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_subFilter_block7
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter3/Filter/subFilter
-- Hierarchy Level: 6
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_subFilter_block7 IS
...
END QPSK_src_subFilter_block7;


ARCHITECTURE rtl OF QPSK_src_subFilter_block7 IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    USE ENTITY work.QPSK_src_FilterTapSystolicPreAddWvlIn_block(rtl);
...
BEGIN
  u_FilterTap_1 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_6 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_7 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_8 : QPSK_src_FilterTapSystolicPreAddWvlIn_block
    PORT MAP( clk => clk,
              enb => enb,
