-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Interpolation_Control.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Interpolation_Control
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/Frequency and Time Synchronizer/Symbol Synchronizer/Interpolation 
-- Contro
-- Hierarchy Level: 4
-- Model version: 9.4
-- 
...
ENTITY QPSK_src_Interpolation_Control IS
...
END QPSK_src_Interpolation_Control;


ARCHITECTURE rtl OF QPSK_src_Interpolation_Control IS
...
BEGIN
  ...
  Interpolation_Control_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS Interpolation_Control_process;

  Interpolation_Control_output : PROCESS (Delta_signed, countReg, muReg, underflowReg)
  ...
  BEGIN
    ...
    muReg_next <= muReg;
    --MATLAB Function 'QPSK/QPSK Rx/Frequency and Time Synchronizer/Symbol Synchronizer/Interpolation Control'
  ...
  END PROCESS Interpolation_Control_output;
