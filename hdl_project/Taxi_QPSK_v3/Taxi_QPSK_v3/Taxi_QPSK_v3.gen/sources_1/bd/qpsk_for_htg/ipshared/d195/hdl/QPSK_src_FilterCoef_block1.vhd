-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterCoef_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterCoef_block1
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/From ADC/Vector Decimation/FIR Decimator/FilterBank/FilterCoef
-- Hierarchy Level: 5
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_FilterCoef_block1 IS
  PORT( CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En16 [16]
        );
END QPSK_src_FilterCoef_block1;


ARCHITECTURE rtl OF QPSK_src_FilterCoef_block1 IS
  ...
  SIGNAL CoefOut_tmp                      : vector_of_signed16(0 TO 15);  -- sfix16_En16 [16]

BEGIN
  -- CoefReg_1
  CoefData <= to_signed(-16#0003#, 16);

  -- CoefReg_2
  CoefData_1 <= to_signed(16#0014#, 16);

  -- CoefReg_3
  CoefData_2 <= to_signed(-16#0047#, 16);

  -- CoefReg_4
  CoefData_3 <= to_signed(16#00BB#, 16);

  -- CoefReg_5
  CoefData_4 <= to_signed(-16#01A3#, 16);

  -- CoefReg_6
  CoefData_5 <= to_signed(16#035A#, 16);

  -- CoefReg_7
  CoefData_6 <= to_signed(-16#06E4#, 16);

  -- CoefReg_8
  CoefData_7 <= to_signed(16#1299#, 16);

  -- CoefReg_9
  CoefData_8 <= to_signed(16#396A#, 16);

  -- CoefReg_10
  CoefData_9 <= to_signed(-16#0A88#, 16);

  -- CoefReg_11
  CoefData_10 <= to_signed(16#04C3#, 16);

  -- CoefReg_12
  CoefData_11 <= to_signed(-16#025C#, 16);

  -- CoefReg_13
  CoefData_12 <= to_signed(16#011D#, 16);

  -- CoefReg_14
  CoefData_13 <= to_signed(-16#0076#, 16);

  -- CoefReg_15
  CoefData_14 <= to_signed(16#0027#, 16);

  -- CoefReg_16
  CoefData_15 <= to_signed(-16#0009#, 16);
