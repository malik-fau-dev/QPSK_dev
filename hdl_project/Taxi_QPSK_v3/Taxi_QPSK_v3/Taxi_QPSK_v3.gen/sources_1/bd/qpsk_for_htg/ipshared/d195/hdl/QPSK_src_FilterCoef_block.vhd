-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterCoef_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterCoef_block
...
ENTITY QPSK_src_FilterCoef_block IS
  PORT( CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En16 [16]
        );
END QPSK_src_FilterCoef_block;


ARCHITECTURE rtl OF QPSK_src_FilterCoef_block IS
...
BEGIN
  -- CoefReg_1
  CoefData <= to_signed(-16#0007#, 16);

  -- CoefReg_2
  CoefData_1 <= to_signed(16#0028#, 16);

  -- CoefReg_3
  CoefData_2 <= to_signed(-16#0082#, 16);

  -- CoefReg_4
  CoefData_3 <= to_signed(16#0148#, 16);

  -- CoefReg_5
  CoefData_4 <= to_signed(-16#02C9#, 16);

  -- CoefReg_6
  CoefData_5 <= to_signed(16#05A6#, 16);

  -- CoefReg_7
  CoefData_6 <= to_signed(-16#0BED#, 16);

  -- CoefReg_8
  CoefData_7 <= to_signed(16#282A#, 16);

  -- CoefReg_9
  CoefData_8 <= to_signed(16#282A#, 16);

  -- CoefReg_10
  CoefData_9 <= to_signed(-16#0BED#, 16);

  -- CoefReg_11
  CoefData_10 <= to_signed(16#05A6#, 16);

  -- CoefReg_12
  CoefData_11 <= to_signed(-16#02C9#, 16);

  -- CoefReg_13
  CoefData_12 <= to_signed(16#0148#, 16);

  -- CoefReg_14
  CoefData_13 <= to_signed(-16#0082#, 16);

  -- CoefReg_15
  CoefData_14 <= to_signed(16#0028#, 16);

  -- CoefReg_16
  CoefData_15 <= to_signed(-16#0007#, 16);
