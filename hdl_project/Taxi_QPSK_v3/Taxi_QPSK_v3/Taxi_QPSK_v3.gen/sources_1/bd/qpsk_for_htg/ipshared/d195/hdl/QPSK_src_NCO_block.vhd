-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_NCO_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_NCO_block
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/Frequency and Time Synchronizer/Coarse Frequency Compensator/NCO
-- Hierarchy Level: 4
-- Model version: 9.4
-- 
-- NCO
...
END QPSK_src_NCO_block;


ARCHITECTURE rtl OF QPSK_src_NCO_block IS

  -- Component Declarations
  COMPONENT QPSK_src_WaveformGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_WaveformGen_block
    USE ENTITY work.QPSK_src_WaveformGen_block(rtl);
...
BEGIN
  u_Wave_inst : QPSK_src_WaveformGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
