-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_subFilter_block8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_subFilter_block8
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter4/Filter/subFilter
-- Hierarchy Level: 6
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_subFilter_block8 IS
...
END QPSK_src_subFilter_block8;


ARCHITECTURE rtl OF QPSK_src_subFilter_block8 IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterTapSystolicWvldin_block6
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : QPSK_src_FilterTapSystolicWvldin_block6
    USE ENTITY work.QPSK_src_FilterTapSystolicWvldin_block6(rtl);
  ...
  SIGNAL ZERO_OUT                         : signed(31 DOWNTO 0);  -- sfix32_En29
  ...
  SIGNAL dout_cast                        : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL muxOut                           : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL dout_1_re_tmp                    : signed(31 DOWNTO 0);  -- sfix32_En29

BEGIN
  u_FilterTap_1 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_6 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_7 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_8 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_9 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_10 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_8,  -- sfix16_En14
              coefIn_0 => coefIn(9),  -- sfix16_En15
              addin => tapout_8,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_9,  -- sfix16_En14
              tapout => tapout_9  -- sfix48_En29
              );

  u_FilterTap_11 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_9,  -- sfix16_En14
              coefIn_0 => coefIn(10),  -- sfix16_En15
              addin => tapout_9,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_10,  -- sfix16_En14
              tapout => tapout_10  -- sfix48_En29
              );

  u_FilterTap_12 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_10,  -- sfix16_En14
              coefIn_0 => coefIn(11),  -- sfix16_En15
              addin => tapout_10,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_11,  -- sfix16_En14
              tapout => tapout_11  -- sfix48_En29
              );

  u_FilterTap_13 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_11,  -- sfix16_En14
              coefIn_0 => coefIn(12),  -- sfix16_En15
              addin => tapout_11,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_12,  -- sfix16_En14
              tapout => tapout_12  -- sfix48_En29
              );

  u_FilterTap_14 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_12,  -- sfix16_En14
              coefIn_0 => coefIn(13),  -- sfix16_En15
              addin => tapout_12,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_13,  -- sfix16_En14
              tapout => tapout_13  -- sfix48_En29
              );

  u_FilterTap_15 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_13,  -- sfix16_En14
              coefIn_0 => coefIn(14),  -- sfix16_En15
              addin => tapout_13,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_14,  -- sfix16_En14
              tapout => tapout_14  -- sfix48_En29
              );

  u_FilterTap_16 : QPSK_src_FilterTapSystolicWvldin_block6
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_14,  -- sfix16_En14
              coefIn_0 => coefIn(15),  -- sfix16_En15
              addin => tapout_14,  -- sfix48_En29
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2deadOut,  -- sfix16_En14
              tapout => tapout_15  -- sfix48_En29
              );
  ...
  dout_cast <= tapout_signed(31 DOWNTO 0);
