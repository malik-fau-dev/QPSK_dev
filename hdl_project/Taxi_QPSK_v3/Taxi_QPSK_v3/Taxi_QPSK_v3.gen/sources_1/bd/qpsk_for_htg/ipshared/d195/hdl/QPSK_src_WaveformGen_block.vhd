-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_WaveformGen_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_WaveformGen_block
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/Frequency and Time Synchronizer/Coarse Frequency Compensator/NCO/WaveformGen
-- Hierarchy Level: 5
-- Model version: 9.4
-- 
...
ENTITY QPSK_src_WaveformGen_block IS
...
END QPSK_src_WaveformGen_block;


ARCHITECTURE rtl OF QPSK_src_WaveformGen_block IS

  -- Component Declarations
  COMPONENT QPSK_src_CosLookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  COMPONENT QPSK_src_SinLookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : QPSK_src_CosLookUpTableGen_block
    USE ENTITY work.QPSK_src_CosLookUpTableGen_block(rtl);

  FOR ALL : QPSK_src_SinLookUpTableGen_block
    USE ENTITY work.QPSK_src_SinLookUpTableGen_block(rtl);
...
BEGIN
  u_Cos_Wave_inst : QPSK_src_CosLookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Sin_Wave_inst : QPSK_src_SinLookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
