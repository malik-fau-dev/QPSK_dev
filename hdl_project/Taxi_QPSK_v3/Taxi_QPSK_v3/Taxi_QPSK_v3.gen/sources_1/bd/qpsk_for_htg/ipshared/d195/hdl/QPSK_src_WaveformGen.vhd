-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_WaveformGen.vhd
...
ENTITY QPSK_src_WaveformGen IS
...
END QPSK_src_WaveformGen;


ARCHITECTURE rtl OF QPSK_src_WaveformGen IS

  -- Component Declarations
  COMPONENT QPSK_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  COMPONENT QPSK_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : QPSK_src_CosLookUpTableGen
    USE ENTITY work.QPSK_src_CosLookUpTableGen(rtl);

  FOR ALL : QPSK_src_SinLookUpTableGen
    USE ENTITY work.QPSK_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : QPSK_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Sin_Wave_inst : QPSK_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
