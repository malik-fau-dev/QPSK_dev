-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterTapSystolicWvldin_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterTapSystolicWvldin_block
...
ENTITY QPSK_src_FilterTapSystolicWvldin_block IS
...
END QPSK_src_FilterTapSystolicWvldin_block;


ARCHITECTURE rtl OF QPSK_src_FilterTapSystolicWvldin_block IS

  -- Signals
  SIGNAL dinReg2_1_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  fTap_output : PROCESS (addin_signed, coefIn_0_signed, dinReg2_1_re_signed, dinRegVld, fTap_addout_reg,
  ...
  BEGIN
    ...
    IF dinRegVld = '1' THEN 
      ...
      fTap_din_reg1_next <= dinReg2_1_re_signed;
