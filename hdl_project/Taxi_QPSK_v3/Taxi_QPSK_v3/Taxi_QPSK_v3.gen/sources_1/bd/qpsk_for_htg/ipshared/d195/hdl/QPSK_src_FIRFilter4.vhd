-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FIRFilter4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FIRFilter4
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Tx/RRC Transmit Filter/FIR Interpolator/FIRFilter4
-- Hierarchy Level: 4
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
END QPSK_src_FIRFilter4;


ARCHITECTURE rtl OF QPSK_src_FIRFilter4 IS

  -- Component Declarations
  COMPONENT QPSK_src_FirRdyLogic_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT QPSK_src_FilterTapSystolic_block3
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT QPSK_src_Addressable_Delay_Line_block8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En16
  ...
  COMPONENT QPSK_src_FilterTapSystolic_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_FirRdyLogic_block2
    USE ENTITY work.QPSK_src_FirRdyLogic_block2(rtl);

  FOR ALL : QPSK_src_Addressable_Delay_Line_block7
    USE ENTITY work.QPSK_src_Addressable_Delay_Line_block7(rtl);

  FOR ALL : QPSK_src_FilterTapSystolic_block3
    USE ENTITY work.QPSK_src_FilterTapSystolic_block3(rtl);

  FOR ALL : QPSK_src_Addressable_Delay_Line_block8
    USE ENTITY work.QPSK_src_Addressable_Delay_Line_block8(rtl);

  FOR ALL : QPSK_src_FilterTapSystolic_block4
    USE ENTITY work.QPSK_src_FilterTapSystolic_block4(rtl);
...
BEGIN
  u_firRdyLogic : QPSK_src_FirRdyLogic_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine0 : QPSK_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine1 : QPSK_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_filterTap0 : QPSK_src_FilterTapSystolic_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : QPSK_src_FilterTapSystolic_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_delayLine0_1 : QPSK_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine1_1 : QPSK_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_filterTap0_1 : QPSK_src_FilterTapSystolic_block4
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1_1 : QPSK_src_FilterTapSystolic_block4
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00" =>
        coeffTableOut1 <= to_signed(16#003F6#, 17);
      WHEN "01" =>
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00" =>
        coeffTableOut1_1 <= to_signed(16#003F6#, 17);
      WHEN "01" =>
