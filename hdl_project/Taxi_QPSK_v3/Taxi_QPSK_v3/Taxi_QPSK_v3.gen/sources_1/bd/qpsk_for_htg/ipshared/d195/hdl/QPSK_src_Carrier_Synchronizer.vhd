-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Carrier_Synchronizer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Carrier_Synchronizer
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/Frequency and Time Synchronizer/Carrier Synchronizer
-- Hierarchy Level: 3
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Carrier_Synchronizer IS
...
END QPSK_src_Carrier_Synchronizer;


ARCHITECTURE rtl OF QPSK_src_Carrier_Synchronizer IS

  -- Component Declarations
  COMPONENT QPSK_src_Phase_Error_Detector
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT QPSK_src_Loop_Filter_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  COMPONENT QPSK_src_Direct_Digital_Synthesis
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          validIn                         :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_Phase_Error_Detector
    USE ENTITY work.QPSK_src_Phase_Error_Detector(rtl);

  FOR ALL : QPSK_src_Loop_Filter_block
    USE ENTITY work.QPSK_src_Loop_Filter_block(rtl);

  FOR ALL : QPSK_src_Direct_Digital_Synthesis
    USE ENTITY work.QPSK_src_Direct_Digital_Synthesis(rtl);
  ...
  SIGNAL Direct_Digital_Synthesis_expOut_im : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Direct_Digital_Synthesis_expOut_im_signed : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Phase_Error_Detector_PhaseError  : std_logic_vector(12 DOWNTO 0);  -- ufix13
  SIGNAL Loop_Filter_v                    : std_logic_vector(39 DOWNTO 0);  -- ufix40
  SIGNAL Direct_Digital_Synthesis_expOut_re : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Direct_Digital_Synthesis_expOut_re_signed : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_Phase_Error_Detector : QPSK_src_Phase_Error_Detector
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Loop_Filter : QPSK_src_Loop_Filter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
              e => Phase_Error_Detector_PhaseError,  -- sfix13_En10
              validIn => Delay1_out1,
              internalRst => Delay11_out1,
              externalRst => rx_resetCS,
              v => Loop_Filter_v  -- sfix40_En39
              );

  u_Direct_Digital_Synthesis : QPSK_src_Direct_Digital_Synthesis
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
              validIn => validIn,
  ...
  Direct_Digital_Synthesis_expOut_im_signed <= signed(Direct_Digital_Synthesis_expOut_im);
  ...
  Direct_Digital_Synthesis_expOut_re_signed <= signed(Direct_Digital_Synthesis_expOut_re);

  Math_Function_out1_re <= Direct_Digital_Synthesis_expOut_re_signed;
  conj_cast <= resize(Direct_Digital_Synthesis_expOut_im_signed, 17);
