-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterTapSystolicWvldin_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterTapSystolicWvldin_block3
...
ENTITY QPSK_src_FilterTapSystolicWvldin_block3 IS
...
END QPSK_src_FilterTapSystolicWvldin_block3;


ARCHITECTURE rtl OF QPSK_src_FilterTapSystolicWvldin_block3 IS

  -- Signals
  SIGNAL dinReg2_0_re_signed              : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL coefIn_0_signed                  : signed(16 DOWNTO 0);  -- sfix17_En19
  SIGNAL addin_signed                     : signed(47 DOWNTO 0);  -- sfix48_En33
  ...
  SIGNAL fTap_addout_reg_next             : signed(47 DOWNTO 0);  -- sfix48_En33
  SIGNAL dinDly2_tmp                      : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL tapout_tmp                       : signed(47 DOWNTO 0);  -- sfix48_En33
