-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Magnitude_Squared_and_Moving_Sum.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Magnitude_Squared_and_Moving_Sum
...
ENTITY QPSK_src_Magnitude_Squared_and_Moving_Sum IS
...
END QPSK_src_Magnitude_Squared_and_Moving_Sum;


ARCHITECTURE rtl OF QPSK_src_Magnitude_Squared_and_Moving_Sum IS
  ...
  SIGNAL Delay11_reg                      : vector_of_signed32(0 TO 19);  -- sfix32 [20]
...
BEGIN
  ...
  Gain_mul_temp <= to_signed(1871183872, 32) * Delay3_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' AND Delay8_out1 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' AND Delay7_out1 = '1' THEN
        Delay14_out1 <= Add1_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        ...
        Delay11_reg(1 TO 19) <= Delay11_reg(0 TO 18);
      END IF;
    END IF;
  END PROCESS Delay11_process;

  Delay11_out1 <= Delay11_reg(19);
