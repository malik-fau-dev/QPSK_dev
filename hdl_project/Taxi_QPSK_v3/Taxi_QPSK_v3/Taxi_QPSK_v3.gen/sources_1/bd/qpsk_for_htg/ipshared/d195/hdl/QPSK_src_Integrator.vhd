-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Integrator.vhd
...
END QPSK_src_Integrator;


ARCHITECTURE rtl OF QPSK_src_Integrator IS

  -- Component Declarations
  COMPONENT QPSK_src_Reset_Generator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          validIn                         :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_Reset_Generator
    USE ENTITY work.QPSK_src_Reset_Generator(rtl);

  -- Signals
  SIGNAL Reset_Generator_reset            : std_logic;
...
BEGIN
  ...
  u_Reset_Generator : QPSK_src_Reset_Generator
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
              validIn => validIn,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        IF Reset_Generator_reset = '1' THEN
          Integ_Reg_out1_re <= to_signed(0, 32);
          Integ_Reg_out1_im <= to_signed(0, 32);
  ...
  Store_Reg_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Store_Reg_out1_re <= to_signed(0, 32);
        Store_Reg_out1_im <= to_signed(0, 32);
      ELSIF enb_1_4_0 = '1' AND Reset_Generator_reset = '1' THEN
