-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Phase_Ambiguity_Estimation_and_Correction.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Phase_Ambiguity_Estimation_and_Correction
...
ENTITY QPSK_src_Phase_Ambiguity_Estimation_and_Correction IS
...
END QPSK_src_Phase_Ambiguity_Estimation_and_Correction;


ARCHITECTURE rtl OF QPSK_src_Phase_Ambiguity_Estimation_and_Correction IS

  -- Component Declarations
  COMPONENT QPSK_src_Phase_Ambiguity_Estimator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  COMPONENT QPSK_src_Average_Estimates
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          endIn                           :   IN    std_logic;
  ...
  COMPONENT QPSK_src_Phase_Ambiguity_Corrector
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : QPSK_src_Phase_Ambiguity_Estimator
    USE ENTITY work.QPSK_src_Phase_Ambiguity_Estimator(rtl);

  FOR ALL : QPSK_src_Average_Estimates
    USE ENTITY work.QPSK_src_Average_Estimates(rtl);

  FOR ALL : QPSK_src_Phase_Ambiguity_Corrector
    USE ENTITY work.QPSK_src_Phase_Ambiguity_Corrector(rtl);
  ...
  SIGNAL Phase_Ambiguity_Estimator_endOut : std_logic;
  SIGNAL Phase_Ambiguity_Estimator_estOut_re : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Phase_Ambiguity_Estimator_estOut_im : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Phase_Ambiguity_Estimator_validOut : std_logic;
  SIGNAL Average_Estimates_avgEst_re      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Average_Estimates_avgEst_im      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Delay12_reg                      : std_logic_vector(4 DOWNTO 0);  -- ufix1 [5]
  SIGNAL Delay12_out1                     : std_logic;
  SIGNAL Delay7_out1                      : std_logic;
  SIGNAL Phase_Ambiguity_Corrector_dataOut_re : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Phase_Ambiguity_Corrector_dataOut_im : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Phase_Ambiguity_Corrector_validOut : std_logic;
...
BEGIN
  u_Phase_Ambiguity_Estimator : QPSK_src_Phase_Ambiguity_Estimator
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Average_Estimates : QPSK_src_Average_Estimates
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Phase_Ambiguity_Corrector : QPSK_src_Phase_Ambiguity_Corrector
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  dataOut_re <= Phase_Ambiguity_Corrector_dataOut_re;

  dataOut_im <= Phase_Ambiguity_Corrector_dataOut_im;
