-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Filter_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Filter_block2
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter2/Filter
-- Hierarchy Level: 5
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Filter_block2 IS
...
END QPSK_src_Filter_block2;


ARCHITECTURE rtl OF QPSK_src_Filter_block2 IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterCoef_block8
    PORT( CoefOut                         :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En15 [16]
          );
  END COMPONENT;

  COMPONENT QPSK_src_subFilter_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_FilterCoef_block8
    USE ENTITY work.QPSK_src_FilterCoef_block8(rtl);

  FOR ALL : QPSK_src_subFilter_block6
    USE ENTITY work.QPSK_src_subFilter_block6(rtl);
...
BEGIN
  u_CoefTable_1 : QPSK_src_FilterCoef_block8
    PORT MAP( CoefOut => CoefOut  -- sfix16_En15 [16]
              );

  u_subFilter_1_re : QPSK_src_subFilter_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_subFilter_1_im : QPSK_src_subFilter_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
