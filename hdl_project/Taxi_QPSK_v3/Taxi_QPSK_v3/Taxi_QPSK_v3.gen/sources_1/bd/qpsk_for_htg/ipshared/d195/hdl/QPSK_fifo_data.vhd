-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_fifo_data
-- Source Path: QPSK/QPSK_axi4_stream_dma_slave/QPSK_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF QPSK_fifo_data IS
...
BEGIN
  ...
  u_QPSK_fifo_data_classic_ram : QPSK_SimpleDualPortRAM_generic
