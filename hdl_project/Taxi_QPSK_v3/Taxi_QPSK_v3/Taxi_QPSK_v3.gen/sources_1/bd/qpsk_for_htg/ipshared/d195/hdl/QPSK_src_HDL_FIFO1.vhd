-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_HDL_FIFO1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_HDL_FIFO1
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DMA/Triggered Capture/Stream FIFO/HDL_FIFO1
-- Hierarchy Level: 4
-- Model version: 9.4
-- 
-- 
...
END QPSK_src_HDL_FIFO1;


ARCHITECTURE rtl OF QPSK_src_HDL_FIFO1 IS

  -- Component Declarations
  COMPONENT QPSK_src_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : QPSK_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.QPSK_src_SimpleDualPortRAM_singlebit(rtl);
  ...
  SIGNAL Num                              : unsigned(10 DOWNTO 0);  -- ufix11
...
BEGIN
  ...
  u_HDL_FIFO1_classic_ram_singlebit : QPSK_src_SimpleDualPortRAM_singlebit
  ...
  w_cz <= '1' WHEN Num > to_unsigned(16#000#, 11) ELSE
      '0';
