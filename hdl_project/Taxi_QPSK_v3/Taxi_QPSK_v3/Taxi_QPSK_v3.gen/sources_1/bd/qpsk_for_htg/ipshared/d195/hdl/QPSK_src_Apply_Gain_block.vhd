-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Apply_Gain_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Apply_Gain_block
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Apply Gain
-- Hierarchy Level: 2
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Apply_Gain_block IS
...
END QPSK_src_Apply_Gain_block;


ARCHITECTURE rtl OF QPSK_src_Apply_Gain_block IS
  ...
  SIGNAL tx_output_gain_signed            : signed(17 DOWNTO 0);  -- sfix18_En15
...
BEGIN
  ...
  tx_output_gain_signed <= signed(tx_output_gain);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay_out1 <= tx_output_gain_signed;
      END IF;
    END IF;
