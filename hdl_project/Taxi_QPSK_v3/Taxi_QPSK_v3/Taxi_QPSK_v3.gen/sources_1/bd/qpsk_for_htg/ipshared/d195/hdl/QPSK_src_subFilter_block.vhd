-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_subFilter_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_subFilter_block
...
ENTITY QPSK_src_subFilter_block IS
...
END QPSK_src_subFilter_block;


ARCHITECTURE rtl OF QPSK_src_subFilter_block IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterTapSystolicWvldin_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_1_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : QPSK_src_FilterTapSystolicWvldin_block
    USE ENTITY work.QPSK_src_FilterTapSystolicWvldin_block(rtl);
  ...
  SIGNAL dout_2_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En30

BEGIN
  u_FilterTap_1 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinReg2_1_re,  -- sfix16_En14
  ...
  u_FilterTap_2 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2,  -- sfix16_En14
  ...
  u_FilterTap_3 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_1,  -- sfix16_En14
  ...
  u_FilterTap_4 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_2,  -- sfix16_En14
  ...
  u_FilterTap_5 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_3,  -- sfix16_En14
  ...
  u_FilterTap_6 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_4,  -- sfix16_En14
  ...
  u_FilterTap_7 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_5,  -- sfix16_En14
  ...
  u_FilterTap_8 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_6,  -- sfix16_En14
  ...
  u_FilterTap_9 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_7,  -- sfix16_En14
  ...
  u_FilterTap_10 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_8,  -- sfix16_En14
  ...
  u_FilterTap_11 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_9,  -- sfix16_En14
  ...
  u_FilterTap_12 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_10,  -- sfix16_En14
  ...
  u_FilterTap_13 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_11,  -- sfix16_En14
  ...
  u_FilterTap_14 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_12,  -- sfix16_En14
  ...
  u_FilterTap_15 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_13,  -- sfix16_En14
  ...
  u_FilterTap_16 : QPSK_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_1_re => dinDly2_14,  -- sfix16_En14
