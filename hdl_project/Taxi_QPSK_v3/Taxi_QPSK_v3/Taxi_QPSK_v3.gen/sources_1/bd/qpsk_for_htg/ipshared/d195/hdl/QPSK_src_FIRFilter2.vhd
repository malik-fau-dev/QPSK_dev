-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FIRFilter2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FIRFilter2
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Tx/RRC Transmit Filter/FIR Interpolator/FIRFilter2
-- Hierarchy Level: 4
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
END QPSK_src_FIRFilter2;


ARCHITECTURE rtl OF QPSK_src_FIRFilter2 IS
  ...
  COMPONENT QPSK_src_Addressable_Delay_Line_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT QPSK_src_FilterTapSystolic
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT QPSK_src_Addressable_Delay_Line_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17_En16
  ...
  COMPONENT QPSK_src_FilterTapSystolic_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_FirRdyLogic_block
    USE ENTITY work.QPSK_src_FirRdyLogic_block(rtl);

  FOR ALL : QPSK_src_Addressable_Delay_Line_block3
    USE ENTITY work.QPSK_src_Addressable_Delay_Line_block3(rtl);

  FOR ALL : QPSK_src_FilterTapSystolic
    USE ENTITY work.QPSK_src_FilterTapSystolic(rtl);

  FOR ALL : QPSK_src_Addressable_Delay_Line_block4
    USE ENTITY work.QPSK_src_Addressable_Delay_Line_block4(rtl);

  FOR ALL : QPSK_src_FilterTapSystolic_block
    USE ENTITY work.QPSK_src_FilterTapSystolic_block(rtl);
...
BEGIN
  u_firRdyLogic : QPSK_src_FirRdyLogic_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine0 : QPSK_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine1 : QPSK_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_filterTap0 : QPSK_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : QPSK_src_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_delayLine0_1 : QPSK_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_delayLine1_1 : QPSK_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_filterTap0_1 : QPSK_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1_1 : QPSK_src_FilterTapSystolic_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00" =>
        coeffTableOut1 <= to_signed(-16#0282B#, 17);
      WHEN "01" =>
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00" =>
        coeffTableOut0 <= to_signed(16#003F6#, 17);
      WHEN "01" =>
        coeffTableOut0 <= to_signed(16#0282B#, 17);
      WHEN "10" =>
        coeffTableOut0 <= to_signed(16#0F990#, 17);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00" =>
        coeffTableOut1_1 <= to_signed(-16#0282B#, 17);
      WHEN "01" =>
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00" =>
        coeffTableOut0_1 <= to_signed(16#003F6#, 17);
      WHEN "01" =>
        coeffTableOut0_1 <= to_signed(16#0282B#, 17);
      WHEN "10" =>
        coeffTableOut0_1 <= to_signed(16#0F990#, 17);
      WHEN OTHERS => 
