-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Phase_Ambiguity_Corrector.vhd
...
ENTITY QPSK_src_Phase_Ambiguity_Corrector IS
...
END QPSK_src_Phase_Ambiguity_Corrector;


ARCHITECTURE rtl OF QPSK_src_Phase_Ambiguity_Corrector IS

  -- Component Declarations
  COMPONENT QPSK_src_HDL_CMA_core_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_HDL_CMA_core_block
    USE ENTITY work.QPSK_src_HDL_CMA_core_block(rtl);

  FOR ALL : QPSK_src_Reciprocal
    USE ENTITY work.QPSK_src_Reciprocal(rtl);
  ...
  SIGNAL Delay41_out1_re_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay41_out1_im_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay36_out1_re_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Delay36_out1_im_1                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  u_Complex_to_Magnitude_Angle : QPSK_src_HDL_CMA_core_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Reciprocal : QPSK_src_Reciprocal
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay41_out1_re_1 <= to_signed(16#0000#, 16);
        Delay41_out1_im_1 <= to_signed(16#0000#, 16);
      ELSIF enb_1_4_0 = '1' THEN
        Delay41_out1_re_1 <= Delay41_out1_re;
        Delay41_out1_im_1 <= Delay41_out1_im;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay36_out1_re_1 <= to_signed(16#0000#, 16);
        Delay36_out1_im_1 <= to_signed(16#0000#, 16);
      ELSIF enb_1_4_0 = '1' THEN
        Delay36_out1_re_1 <= Delay36_out1_re;
        Delay36_out1_im_1 <= Delay36_out1_im;
      END IF;
    END IF;
  ...
  Product2_mul_temp <= Delay36_out1_re_1 * Delay28_out1_re;
  Product2_sub_cast <= Product2_mul_temp(25 DOWNTO 10);
  Product2_mul_temp_1 <= Delay36_out1_im_1 * Delay28_out1_im;
  Product2_sub_cast_1 <= Product2_mul_temp_1(25 DOWNTO 10);
  Product2_out1_re <= Product2_sub_cast - Product2_sub_cast_1;
  Product2_mul_temp_2 <= Delay36_out1_im_1 * Delay28_out1_re;
  Product2_add_cast <= Product2_mul_temp_2(25 DOWNTO 10);
  Product2_mul_temp_3 <= Delay36_out1_re_1 * Delay28_out1_im;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_0 = '1' THEN
        Delay3_reg(0) <= Reciprocal_dataOut_signed;
  ...
  Multiport_Switch1_out1_re <= Delay41_out1_re_1 WHEN Constant_out1 = '0' ELSE
      Delay39_out1_re;
  
  Multiport_Switch1_out1_im <= Delay41_out1_im_1 WHEN Constant_out1 = '0' ELSE
      Delay39_out1_im;
