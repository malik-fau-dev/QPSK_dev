-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterCoef_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterCoef_block10
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter4/Filter/FilterCoef
-- Hierarchy Level: 6
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_FilterCoef_block10 IS
  PORT( CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En15 [16]
        );
END QPSK_src_FilterCoef_block10;


ARCHITECTURE rtl OF QPSK_src_FilterCoef_block10 IS
...
BEGIN
  ...
  -- CoefReg_2
  CoefData_1 <= to_signed(16#004F#, 16);

  -- CoefReg_3
  CoefData_2 <= to_signed(-16#00ED#, 16);

  -- CoefReg_4
  CoefData_3 <= to_signed(16#023A#, 16);

  -- CoefReg_5
  CoefData_4 <= to_signed(-16#04B8#, 16);

  -- CoefReg_6
  CoefData_5 <= to_signed(16#0987#, 16);

  -- CoefReg_7
  CoefData_6 <= to_signed(-16#1510#, 16);

  -- CoefReg_8
  CoefData_7 <= to_signed(16#72D4#, 16);

  -- CoefReg_9
  CoefData_8 <= to_signed(16#2531#, 16);

  -- CoefReg_10
  CoefData_9 <= to_signed(-16#0DC9#, 16);

  -- CoefReg_11
  CoefData_10 <= to_signed(16#06B5#, 16);

  -- CoefReg_12
  CoefData_11 <= to_signed(-16#0347#, 16);

  -- CoefReg_13
  CoefData_12 <= to_signed(16#0177#, 16);

  -- CoefReg_14
  CoefData_13 <= to_signed(-16#008E#, 16);

  -- CoefReg_15
  CoefData_14 <= to_signed(16#0028#, 16);

  -- CoefReg_16
  CoefData_15 <= to_signed(-16#0006#, 16);
