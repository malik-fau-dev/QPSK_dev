-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Coarse_Frequency_Compensator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Coarse_Frequency_Compensator
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/Frequency and Time Synchronizer/Coarse Frequency Compensator
-- Hierarchy Level: 3
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Coarse_Frequency_Compensator IS
...
END QPSK_src_Coarse_Frequency_Compensator;


ARCHITECTURE rtl OF QPSK_src_Coarse_Frequency_Compensator IS

  -- Component Declarations
  COMPONENT QPSK_src_Raise_Power_to_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  COMPONENT QPSK_src_Coarse_Frequency_Estimator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En12
  ...
  COMPONENT QPSK_src_CFO_step_change_detector
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_Raise_Power_to_4
    USE ENTITY work.QPSK_src_Raise_Power_to_4(rtl);

  FOR ALL : QPSK_src_Coarse_Frequency_Estimator
    USE ENTITY work.QPSK_src_Coarse_Frequency_Estimator(rtl);

  FOR ALL : QPSK_src_NCO_block
    USE ENTITY work.QPSK_src_NCO_block(rtl);

  FOR ALL : QPSK_src_CFO_step_change_detector
    USE ENTITY work.QPSK_src_CFO_step_change_detector(rtl);
  ...
  SIGNAL Raise_Power_to_4_dataOut_re      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Raise_Power_to_4_dataOut_im      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL Raise_Power_to_4_validOut        : std_logic;
  SIGNAL Coarse_Frequency_Estimator_normFreqEst : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL Coarse_Frequency_Estimator_normFreqEst_signed : signed(34 DOWNTO 0);  -- sfix35_En34
...
BEGIN
  u_Raise_Power_to_4 : QPSK_src_Raise_Power_to_4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Coarse_Frequency_Estimator : QPSK_src_Coarse_Frequency_Estimator
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_CFO_step_change_detector : QPSK_src_CFO_step_change_detector
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  Coarse_Frequency_Estimator_normFreqEst_signed <= signed(Coarse_Frequency_Estimator_normFreqEst);

  Gain_cast <= resize(Coarse_Frequency_Estimator_normFreqEst_signed, 38);
  ...
  rx_normCoarseFreqEst <= std_logic_vector(Data_Type_Conversion3_out1);
