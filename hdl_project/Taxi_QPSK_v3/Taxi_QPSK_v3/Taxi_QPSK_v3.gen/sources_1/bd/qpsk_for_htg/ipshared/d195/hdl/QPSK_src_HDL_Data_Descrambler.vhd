-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_HDL_Data_Descrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_HDL_Data_Descrambler
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/HDL Data Descrambler
-- Hierarchy Level: 2
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_HDL_Data_Descrambler IS
...
END QPSK_src_HDL_Data_Descrambler;


ARCHITECTURE rtl OF QPSK_src_HDL_Data_Descrambler IS
...
BEGIN
  ...
  Unit_Delay_Enabled_Resettable_Synchronous5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Unit_Delay_Enabled_Resettable_Synchronous6_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Unit_Delay_Enabled_Resettable_Synchronous7_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
