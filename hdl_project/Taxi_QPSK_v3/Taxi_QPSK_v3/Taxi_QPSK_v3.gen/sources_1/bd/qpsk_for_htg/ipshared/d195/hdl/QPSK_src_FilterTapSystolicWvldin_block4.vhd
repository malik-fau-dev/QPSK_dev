-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterTapSystolicWvldin_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterTapSystolicWvldin_block4
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter1/Filter/subFilter/FilterTapSystolicWvldin
-- Hierarchy Level: 7
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_FilterTapSystolicWvldin_block4 IS
...
END QPSK_src_FilterTapSystolicWvldin_block4;


ARCHITECTURE rtl OF QPSK_src_FilterTapSystolicWvldin_block4 IS

  -- Signals
  SIGNAL dinReg2_0_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL coefIn_0_signed                  : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL fTap_coef_reg1_next              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL fTap_din_reg2_next               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL fTap_coef_reg2_next              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL fTap_mult_reg_next               : signed(31 DOWNTO 0);  -- sfix32_En28
