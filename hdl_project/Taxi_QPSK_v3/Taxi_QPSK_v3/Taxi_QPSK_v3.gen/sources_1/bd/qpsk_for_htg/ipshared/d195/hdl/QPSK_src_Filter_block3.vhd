-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Filter_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Filter_block3
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter3/Filter
-- Hierarchy Level: 5
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Filter_block3 IS
...
END QPSK_src_Filter_block3;


ARCHITECTURE rtl OF QPSK_src_Filter_block3 IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterCoef_block9
    PORT( CoefOut                         :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En15 [16]
          );
  END COMPONENT;

  COMPONENT QPSK_src_subFilter_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_FilterCoef_block9
    USE ENTITY work.QPSK_src_FilterCoef_block9(rtl);

  FOR ALL : QPSK_src_subFilter_block7
    USE ENTITY work.QPSK_src_subFilter_block7(rtl);
...
BEGIN
  u_CoefTable_1 : QPSK_src_FilterCoef_block9
    PORT MAP( CoefOut => CoefOut  -- sfix16_En15 [16]
              );

  u_subFilter_1_re : QPSK_src_subFilter_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_subFilter_1_im : QPSK_src_subFilter_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
