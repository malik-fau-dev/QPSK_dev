-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_FilterTapSystolicWvldin_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_FilterTapSystolicWvldin_block1
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/From ADC/Vector Decimation/FIR Decimator/FilterBank/subFilter/FilterTapSystolicWvldin
-- Hierarchy Level: 6
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_FilterTapSystolicWvldin_block1 IS
...
END QPSK_src_FilterTapSystolicWvldin_block1;


ARCHITECTURE rtl OF QPSK_src_FilterTapSystolicWvldin_block1 IS

  -- Signals
  SIGNAL dinReg2_2_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  fTap_output : PROCESS (addin_signed, coefIn_0_signed, dinReg2_2_re_signed, dinRegVld, fTap_addout_reg,
  ...
  BEGIN
    ...
    IF dinRegVld = '1' THEN 
      ...
      fTap_din_reg1_next <= dinReg2_2_re_signed;
