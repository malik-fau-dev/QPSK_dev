-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_fifo_TLAST_OUT
-- Source Path: QPSK/QPSK_axi4_stream_dma_master/QPSK_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END QPSK_fifo_TLAST_OUT;


ARCHITECTURE rtl OF QPSK_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT QPSK_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : QPSK_SimpleDualPortRAM_singlebit
    USE ENTITY work.QPSK_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_QPSK_fifo_TLAST_OUT_classic_ram_singlebit : QPSK_SimpleDualPortRAM_singlebit
