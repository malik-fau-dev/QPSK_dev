-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Extract_Frequency.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Extract_Frequency
...
ENTITY QPSK_src_Extract_Frequency IS
...
END QPSK_src_Extract_Frequency;


ARCHITECTURE rtl OF QPSK_src_Extract_Frequency IS

  -- Component Declarations
  COMPONENT QPSK_src_HDL_CMA_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_HDL_CMA_core
    USE ENTITY work.QPSK_src_HDL_CMA_core(rtl);
...
BEGIN
  u_Complex_to_Magnitude_Angle_HDL_Optimized : QPSK_src_HDL_CMA_core
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_4_0 = '1' AND Complex_to_Magnitude_Angle_HDL_Optimized_out2 = '1' THEN
