-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Filter_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Filter_block
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/RRC Receive Filter/Filter
-- Hierarchy Level: 3
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Filter_block IS
...
END QPSK_src_Filter_block;


ARCHITECTURE rtl OF QPSK_src_Filter_block IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterCoef_block6
    PORT( CoefOut                         :   OUT   vector_of_std_logic_vector16(0 TO 16)  -- sfix16_En15 [17]
          );
  END COMPONENT;

  COMPONENT QPSK_src_subFilter_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_FilterCoef_block6
    USE ENTITY work.QPSK_src_FilterCoef_block6(rtl);

  FOR ALL : QPSK_src_subFilter_block4
    USE ENTITY work.QPSK_src_subFilter_block4(rtl);
...
BEGIN
  u_CoefTable_1 : QPSK_src_FilterCoef_block6
    PORT MAP( CoefOut => CoefOut  -- sfix16_En15 [17]
              );

  u_subFilter_1_re : QPSK_src_subFilter_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_subFilter_1_im : QPSK_src_subFilter_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
