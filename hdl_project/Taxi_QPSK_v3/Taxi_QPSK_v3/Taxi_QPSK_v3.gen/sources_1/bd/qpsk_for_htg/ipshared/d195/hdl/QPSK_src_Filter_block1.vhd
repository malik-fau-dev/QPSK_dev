-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_Filter_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_Filter_block1
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/To DAC/Vector Interpolation/FIR Interpolator/FIRFilter1/Filter
-- Hierarchy Level: 5
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_Filter_block1 IS
...
END QPSK_src_Filter_block1;


ARCHITECTURE rtl OF QPSK_src_Filter_block1 IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterCoef_block7
    PORT( CoefOut                         :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En14 [16]
          );
  END COMPONENT;

  COMPONENT QPSK_src_subFilter_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : QPSK_src_FilterCoef_block7
    USE ENTITY work.QPSK_src_FilterCoef_block7(rtl);

  FOR ALL : QPSK_src_subFilter_block5
    USE ENTITY work.QPSK_src_subFilter_block5(rtl);
  ...
  SIGNAL dout_1_re                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  ...
  SIGNAL dout_1_im                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL doutVlddeadOut                   : std_logic;

BEGIN
  u_CoefTable_1 : QPSK_src_FilterCoef_block7
    PORT MAP( CoefOut => CoefOut  -- sfix16_En14 [16]
              );

  u_subFilter_1_re : QPSK_src_subFilter_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dinReg2_0_re),  -- sfix16_En14
              coefIn => CoefOut,  -- sfix16_En14 [16]
              dinRegVld => dinReg2Vld,
              syncReset => syncReset,
              dout_1_re => dout_1_re,  -- sfix30_En28
              doutVld => doutVld
              );

  u_subFilter_1_im : QPSK_src_subFilter_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              dinRegVld => dinReg2Vld,
              syncReset => syncReset,
              dout_1_re => dout_1_im,  -- sfix30_En28
