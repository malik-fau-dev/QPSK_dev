-- -------------------------------------------------------------
-- 
-- File Name: C:\QPSK\hdl_prj_zcu111\hdlsrc\hdlcoder_QPSKTxRx_RFSoC\QPSK_src_subFilter_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: QPSK_src_subFilter_block4
-- Source Path: hdlcoder_QPSKTxRx_RFSoC/QPSK/QPSK Rx/RRC Receive Filter/Filter/subFilter
-- Hierarchy Level: 4
-- Model version: 9.4
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_src_subFilter_block4 IS
...
END QPSK_src_subFilter_block4;


ARCHITECTURE rtl OF QPSK_src_subFilter_block4 IS

  -- Component Declarations
  COMPONENT QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
  ...
  FOR ALL : QPSK_src_FilterTapSystolicPreAddWvlIn
    USE ENTITY work.QPSK_src_FilterTapSystolicPreAddWvlIn(rtl);
...
BEGIN
  u_FilterTap_1 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_6 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_7 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_8 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_9 : QPSK_src_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb => enb,
