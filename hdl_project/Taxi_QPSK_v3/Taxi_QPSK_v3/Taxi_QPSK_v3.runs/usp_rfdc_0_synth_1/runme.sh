...
HD_PWD='C:/Taxi/Taxi_QPSK_v3/Taxi_QPSK_v3/Taxi_QPSK_v3.runs/usp_rfdc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usp_rfdc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usp_rfdc_0.tcl
