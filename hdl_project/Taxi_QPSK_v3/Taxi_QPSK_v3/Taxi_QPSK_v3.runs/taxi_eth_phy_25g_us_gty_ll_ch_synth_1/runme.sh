...
HD_PWD='/home/sarial/intellifpga/taxi/src/eth/example/HTG_ZRF8/fpga/fpga_R2_ZU48DR/fpga.runs/taxi_eth_phy_25g_us_gty_ll_ch_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log taxi_eth_phy_25g_us_gty_ll_ch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source taxi_eth_phy_25g_us_gty_ll_ch.tcl
